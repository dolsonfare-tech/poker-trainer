...
const SCENARIOS = [
  ...
  mkScenario({
    ...
    actionHistory: [
      { street: 'PRE', segments: [{ text: 'you raise to $6', you: true }, { text: 'BB calls' }] },
      { street: 'FLOP', segments: [{ text: 'BB checks' }, { text: 'you bet', you: true }, { text: 'BB calls' }] },
      { street: 'TURN', segments: [{ text: 'BB checks' }, { text: 'you bet', you: true }, { text: 'BB calls' }] },
  ...
  mkScenario({
    ...
    actionHistory: [
      { street: 'PRE', segments: [{ text: 'BTN raises to $6' }, { text: 'you call', you: true }] },
      { street: 'FLOP', segments: [{ text: 'you check', you: true }, { text: 'BTN bets' }, { text: 'you call', you: true }] },
      { street: 'TURN', segments: [{ text: 'you check', you: true }, { text: 'BTN bets' }, { text: 'you call', you: true }] },
